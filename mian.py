...
def generate_certificate(names, positions, position_of_name, position_of_rule, font_of_name, font_of_rule, image):
     ...
     for n, p in zip(names, positions):
        ...
        draw.text((position_of_name[0], position_of_name[1]), n, font=font_of_name, fill=(0, 0, 0))
...
image = cv2.imread(r"C:\Users\victo\OneDrive\Desktop\certificate_generator_python\certificate teamplate\certificate.jpg")
